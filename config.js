...
const gameConfig = {
	...
	*/
	...
	/* --- (旧方式: 後方互換のため残されていますが、現在はwinHorizontalProbabilityを使用) ---
	...
	*/
	...
	debug: {
		stopLogs: false,  // trueにすると、リール停止時の速度や目標位置などの概要ログを出力します。
		frameLogs: false, // trueにすると、フレームごとのリール位置など詳細なログを出力します。非常に重くなるため注意。
	},
};